...
useEffect(() => {
 ...
 const navigate = useNavigate();
  ...
  const handleConfirmDelete = async () => {
    try {
      setIsLoading(true)
      const res = await deleteData(`/slideBanner/${deleteId}`);
        ...
        <div className="categoryListContainer">
          <div className="breadcrumbContainer">
            <div className="breadcrumb">
              <h2>slide Banner List</h2>
              <div className="breadRight">
                <span>
                  <Link to="/">Home</Link>~
                </span>
                <span>
                  <Link to="/" style={{color:"black"}}>slide Banner</Link>~
                </span>
